% unofficial poster template for Boston College
...
%if the code doesn't compile the first time around in Overleaf, recompile and it should work just fine
...
\institute[shortinst]{\textbf{MCAS/CSOM/Lynch/etc.}, Boston College}

% ====================
% Footer (optional)
% ====================

\footercontent{Bottom text \hfill
  \href{mailto:youremail@tcd.ie}{youremail@bc.edu}}
